...
_**Important:** Your PR should go from your branch in your fork to main on the upstream repository. Check out GitHub's pull request docs for complete instructions._
...
- Read the comment carefully. Make sure you understand what they're asking.
- The reviewer will typically leave comments on specific lines or the overall approach.
- Make the change in your branch and push a new commit.
- Reply to the comment confirming the change: "Updated in [commit hash]. [Switched to the factory approach, or equivalent description of your change] as suggested."
- If you disagree with the suggestion, say so respectfully and explain your reasoning. Open source is a conversation.
- When all requested changes are complete, leave a comment on the PR tagging the reviewer (@username) and mentioning that the PR is ready for another look.
...
"🚀 Phase IV Complete — PR submitted! [link to your pull request]"
